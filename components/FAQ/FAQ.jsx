                    ...
                    >
                      <Typography variant="h2" sx={{
                        fontSize: {
                          ...
                          md: '36px',
                          xs: '24px'
                        }, fontFamily: 'AvenirNextRegular', color: '#FFFFFF', textTransform: 'capitalize', textAlign: 'start',
                      }} component="div">
                        {item.question}
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails sx={{ backgroundColor: '#0F242B' }} >
                      <Typography variant="h2" sx={{
                        fontSize: {
                          ...
                          md: '36px',
                          xs: '24px'
                        }, fontFamily: 'AvenirNextRegular', color: '#22A3D8', textTransform: 'capitalize', textAlign: 'start',
                      }} component="div">
                        {item.answer}
                      </Typography>
                    </AccordionDetails>
